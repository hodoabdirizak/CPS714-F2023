...
const getEventsWithVenues = async () => {
  try {
    ...
    const result = await sql.query(`
      SELECT e.Event_id, e.Event_name, e.Event_start_date, e.Event_start_time, e.Capacity, e.Event_type, e.Event_description, 
      ...
      INNER JOIN Venue_caterer cat ON v.Venue_id = cat.Venue_id
