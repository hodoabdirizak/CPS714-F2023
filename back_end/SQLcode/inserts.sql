...
insert into Organizer values ( 2, 'Krusty Krab', 'Yellow square that is ready','rippedmypants.com');
insert into Organizer values ( 5, 'Barbz', 'Super Bass', 'BarbzRules.com');
